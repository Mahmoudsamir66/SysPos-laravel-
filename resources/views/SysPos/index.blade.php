                                ...
                                <div id="carousel-example-caption" class="carousel slide" data-ride="carousel">
                                    ...
                                    <div class="carousel-inner" role="listbox">
                                        <div class="carousel-item active">
                                            <img src="{{asset('public/app-assets/img/slide.PNG')}}" alt="First slide">
                                        </div>
                                        <div class="carousel-item">
                                            <img src="{{asset('public/app-assets/img/slide2.PNG')}}" alt="Second slide">
                                        </div>
                                        <div class="carousel-item">
                                            <img src="{{asset('public/app-assets/img/slide3.PNG')}}" alt="Third slide">
                                        </div>
                                    </div>
                        ...
                        <div class="px-3 py-3">
                            <div class="row text-white">
                                <div class="col-6">
                                    ...
                                    <h4 class="pt-1 m-0 text-white"> <i class="fa fa-long-arrow-up"></i></h4>
                                </div>
                    ...
                    <div class="card-body">
                        <div class="px-3 py-3">
                            <div class="row text-white">
                                ...
                                <div class="col-6 text-right pl-0">
                                    <h4 class="text-white mb-2">{{$kinds}}</h4>
                                    <span>الاصناف</span>
                                    <br>
                    ...
                    <div class="card-body">
                        <div class="px-3 py-3">
                            <div class="row text-white">
                                ...
                                <div class="col-6 text-right pl-0">
                                    <h4 class="text-white mb-2">{{$stores}} </h4>
                                    <span>المخازن</span>
                                    <br>
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover table-xl mb-0" id="recent-orders">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <button class="btn btn-sm btn-outline-danger round mb-0" type="button"></button>
                                        </td>
                                         <td class="text-truncate">Id </td>
                                        <td class="text-truncate">Name </td>
                                        <td class="text-truncate">Date</td>
                                        <td class="text-truncate">StartTime</td>
                                        <td class="text-truncate">ndTime </td>
                                    </tr>
