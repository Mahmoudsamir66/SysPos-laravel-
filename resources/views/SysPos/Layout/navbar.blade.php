                ...
                <ul class="navbar-nav">
                    ...
                    <li class="dropdown nav-item mt-1">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <div class="arrow_box_right"><a href="javascript:;" class="dropdown-item py-1"><img src="{{asset('public/app-assets/img/flags/us.png')}}" alt="English Flag" class="langimg"/><span> English</span></a><a href="javascript:;" class="dropdown-item py-1"><img src="{{asset('public/app-assets/img/flags/es.png')}}" alt="Spanish Flag" class="langimg"/><span> Spanish</span></a><a href="javascript:;" class="dropdown-item py-1"><img src="{{asset('public/app-assets/img/flags/br.png')}}" alt="Portuguese Flag" class="langimg"/><span> Portuguese</span></a><a href="javascript:;" class="dropdown-item"><img src="{{asset('public/app-assets/img/flags/de.png')}}" alt="French Flag" class="langimg"/><span> French</span></a></div>
                        </div>
                    </li>
                    <li class="dropdown nav-item mt-1">
                    ...
                    <li class="dropdown nav-item mr-0">
                        <a id="dropdownBasic3" href="#" data-toggle="dropdown" class="nav-link position-relative dropdown-user-link dropdown-toggle">
                            <span class="avatar avatar-online"><img id="navbar-avatar" src="{{asset('public/app-assets/img/portrait/small/222.jpg')}}" alt="avatar"/></span>
                ...
                <section id="minimal-statistics-bg">
                    <div class="row">
                        <div class="col-12 mt-3 mb-1">
                            <h2 class="content-header"> Welcome      {{auth()->user()->email}} in Pos System .. </h2>
