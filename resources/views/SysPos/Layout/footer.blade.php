                ...
                <div class="tab-content">
                    ...
                    <div id="settings-tab" aria-labelledby="base-tab2" class="tab-pane">
                        <div id="settings" class="col-12">
                            <h6 class="mt-1 mb-3 text-bold-400"></h6>
...
<div class="customizer border-left-blue-grey border-left-lighten-4 d-none d-sm-none d-md-block">
    ...
    <div data-ps-id="df6a5ce4-a175-9172-4402-dabd98fc9c0a" class="customizer-content p-3 ps-container ps-theme-dark">
        ...
        <div class="cz-bg-image row">
            <div class="col mb-3"><img src="{{asset('public/app-assets/img/sidebar-bg/01.jpg')}}" width="50" height="100" alt="Bg image1" class="rounded box-shadow-2"></div>
            <div class="col mb-3"><img src="{{asset('public/app-assets/img/sidebar-bg/02.jpg')}}" width="50" height="100" alt="Bg image2" class="rounded box-shadow-2"></div>
            <div class="col mb-3"><img src="{{asset('public/app-assets/img/sidebar-bg/03.jpg')}}" width="50" height="100" alt="Bg image3" class="rounded box-shadow-2"></div>
            <div class="col mb-3"><img src="{{asset('public/app-assets/img/sidebar-bg/04.jpg')}}" width="50" height="100" alt="Bg image4" class="rounded box-shadow-2"></div>
            <div class="col mb-3"><img src="{{asset('public/app-assets/img/sidebar-bg/05.jpg')}}" width="50" height="100" alt="Bg image5" class="rounded box-shadow-2"></div>
            <div class="col mb-3"><img src="{{asset('public/app-assets/img/sidebar-bg/06.jpg')}}" width="50" height="100" alt="Bg image6" class="rounded box-shadow-2"></div>
            <div class="col mb-3"><img src="{{asset('public/app-assets/img/sidebar-bg/07.jpg')}}" width="50" height="100" alt="Bg image7" class="rounded box-shadow-2"></div>
            <div class="col mb-3"><img src="{{asset('public/app-assets/img/sidebar-bg/08.jpg')}}" width="50" height="100" alt="Bg image8" class="rounded box-shadow-2"></div>
        </div>
        <hr>
        <div class="togglebutton">
            <div class="switch">
...
<script src="{{asset('public/app-assets/vendors/js/core/jquery-3.3.1.min.j')}}s"></script>
...
<script src="{{asset('public/app-assets/vendors/js/pace/pace.min.j')}}s"></script>
